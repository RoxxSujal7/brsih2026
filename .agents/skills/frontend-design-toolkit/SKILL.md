...
description: Comprehensive curated frontend design toolkit for Claude Code and Antigravity. Covers 70+ tools, design skills to eliminate AI slop, site-wide theming, OKLCH design tokens, animation and motion libraries (GSAP, Framer Motion), UI/UX intelligence, testing, and recommended frontend stacks. Use when designing, theming, styling, animating, or building modern, high-end web applications.
---
