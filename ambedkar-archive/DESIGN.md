...
component-patterns:
  ...
  # 3. Button-in-Button Primary Controls
  pill-button:
    borderRadius: "9999px"
    padding: "10px 22px"
...
# Implementation Guide for Ambedkar Heritage Archive

## 1. Architectural Philosophy
The Ambedkar Digital Heritage Archive is designed as a **living national monument**. It rejects modern commercial landing page patterns (aggressive floating CTAs, neon gradients, game-like particle storms, sneaker-launch copy). Every screen is an architectural chamber: quiet, deeply legible, dignified, and anchored by verified primary sources.

## 2. Using Tokens in CSS
All tokens are declared as CSS Custom Properties in `frontend/css/style.css`, `frontend/css/apple-design.css`, and `frontend/css/spatial3D.css`:
```css
:root {
  --gold: #d4af37;
  --gold-light: #f3e5ab;
...
## 3. Responsive Scrollytelling Standard
On `slides.html`, chapters are laid out as vertical double-bezel cards pinned against subtle parallax archival imagery. In presentation mode (`mode-deck`), the view seamlessly scales to an authentic 16:9 canvas with arrow key choreography and speaker notes.
